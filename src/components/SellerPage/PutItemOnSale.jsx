...
const PutItemOnSale = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(apiEndpoint, itemDetailsToSend, {
        headers: {
        ...
        <div className="basis-11/12 my-4 me-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-4 content-center">
              ...
              <button className="px-4 py-3 bg-cyan-500 rounded-xl mb-3">
                Submit
              </button>
            </div>
          </form>
